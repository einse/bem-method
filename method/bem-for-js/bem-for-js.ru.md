...
Добавим блоку `logo` JavaScript-функциональность: теперь нажатие на логотип вызывает какое-либо действие. Согласно БЭМ-методологии новое поведение блока `logo` будет реализовано следующим образом:
  * в отдельном файле;
